...
cd /pool/m3/KBP/software/EnglishIE/ENIE
...
java -cp $CLASSPATH -Xmx8g -Xms8g -server -DjetHome=./ cuny.blender.englishie.ace.IETagger /pool/m3/KBP/software/EnglishIE/ENIE/props/enie_unsentence.property $1 $2 $3
