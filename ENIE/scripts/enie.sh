...
java -cp $CLASSPATH -Xmx8g -Xms8g -server -DjetHome=./ cuny.blender.englishie.ace.IETagger /m3/KBP/software/EnglishIE/ENIE/props/enie.property /m3/KBP/software/EnglishIE/ENIE/example/filelist /m3/KBP/software/EnglishIE/ENIE/example/sgm /m3/KBP/software/EnglishIE/ENIE/example/out
