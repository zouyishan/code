...
public class ETAttributeV1 {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int runs = 0; runs < 1; runs++) {
			...
			for (int fold = 0; fold < 1; fold++) {
				...
				//splitCorpus(fold,v);
				ETAttributeV1 et = new ETAttributeV1();
	...
	private static void evaluateEventTagger(ETAttributeV1 et) throws IOException {
