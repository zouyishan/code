...
public class ETAttributeV5 {
	...
	static boolean trainCorefModel = true;
	...
	public static void main(String[] args) throws IOException {
		...
		FileWriter fw1 = new FileWriter(logFileName1);
		FileWriter fw2 = new FileWriter(logFileName2);
		FileWriter fw3 = new FileWriter(logFileName3);
		fw1.close();
		fw2.close();
		fw3.close();
		for (int runs = 0; runs < 10; runs++) {
			...
			for (int fold = 0; fold < 10; fold++) {
				...
				fw1 = new FileWriter(logFileName1, true);
				fw2 = new FileWriter(logFileName2, true);
				fw3= new FileWriter(logFileName3, true);
				fw1.write("folds=" + Integer.toString(fold) + "\n");
				fw2.write("folds=" + Integer.toString(fold) + "\n");
				fw3.write("folds=" + Integer.toString(fold) + "\n");
				
				splitCorpus(fold,v);
				ETAttributeV5 et = new ETAttributeV5();
				...
				processOnlyEvenDocuments = false;
					...
					//	for (CLUSTER_THRESHOLD = 0.05; CLUSTER_THRESHOLD < 0.98; CLUSTER_THRESHOLD += 0.05) {
	...
	private static void evaluateEventTagger(ETAttributeV5 et, int choice)
	throws IOException {
