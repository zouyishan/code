...
public class ETCorefSystem {
	...
	public static void main (String[] args) throws IOException {
		...
		for (int runs = 0; runs < 1; runs++) {
			...
			for (int fold = 0; fold < 1; fold++) {
				...
				ETCorefSystem et = new ETCorefSystem();
	...
	private static void evaluateEventTagger (ETCorefSystem et)  throws IOException {
