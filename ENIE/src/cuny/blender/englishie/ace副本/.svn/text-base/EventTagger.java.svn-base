...
public class EventTagger {
	...
	public static String triplesSuffix =
	...
	public void tag (String fileList) throws IOException {
		...
		while ((currentDocPath = reader.readLine()) != null) {
		  ...
		  String textFile = ace + (useParser ? "perfect-parses/" : "") + currentDocPath;
			String xmlFile = ace + currentDocPath.replaceFirst(".sgm", ".sys.apf");
			String outputFile = home + "output/output4/" + currentDocPath.replaceFirst(".sgm", ".apf");
			// for evaluation --------------
			/*
	...
	static final String fileListTrain = home + "totalfilelist";
	...
	static final boolean evaluate = false;
	...
	public static void main (String[] args) throws IOException {
		if (useParser)
			...
			JetTest.initializeFromConfig("props/MEaceconf50.properties");
