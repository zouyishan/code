...
public class AceEventCorefGraphTrain {
	...
	public AceEventCorefGraphTrain() {
	...
	static String fileListTrain = home + "totalfilelist";
	...
	public static void main(String[] args) throws IOException {
		...
		//String home = "C:/Users/blender/workspace/blender/corpus/ACE05/";
		...
		JetTest.initializeFromConfig(home+"../../props/AceEventCoref.properties");
		...
		AceEventCorefGraphTrain et = new AceEventCorefGraphTrain();
	...
	private static void evaluateEventTagger(AceEventCorefGraphTrain et, int choice)
			throws IOException {
