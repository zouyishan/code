...
public class ETCorefRalph {
	...
	static final String home ="/home/zheng/Application/Coref/ex5/ACE05/";
	...
	public static void main (String[] args) throws IOException {
		...
		for (int runs = 0; runs < 10; runs++) {
			...
			for (int fold = 0; fold < 10; fold++) {
				...
				ETCorefRalph et = new ETCorefRalph();
		
				for (FEATURE_SET=0;FEATURE_SET<1;FEATURE_SET++){
	...
	private static void evaluateEventTagger (ETCorefRalph et)  throws IOException {
