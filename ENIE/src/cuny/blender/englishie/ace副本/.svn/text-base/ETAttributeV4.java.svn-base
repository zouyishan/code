...
public class ETAttributeV4 {
	...
	static String logFileName = home+"error";
	...
	public static void main(String[] args) throws IOException {
		...
		for (int runs = 0; runs < 10; runs++) {
			...
			for (int fold = 0; fold < 10; fold++) {
				...
				splitCorpus(fold,v);
				ETAttributeV4 et = new ETAttributeV4();
				...
				for (FEATURE_SET=-1;FEATURE_SET<4;FEATURE_SET++){
					if (FEATURE_SET==-1)
					{
						trainCorefModel=false;
					}
					else
					{
						trainCorefModel=true;
					}
					if (trainCorefModel) {
						et.trainCorefModel ();
					}
					if (evaluate) {
						...
						fw.write(Integer.toString(ee2.N)+"\t"+Double.toString(ee2.W1)+"\t"+Double.toString(ee2.W2)+"\t"+
								Double.toString(ee2.M1)+"\t"+Double.toString(ee2.M2)+"\n");
	...
	private static void evaluateEventTagger(ETAttributeV4 et) throws IOException {
