...
public class ETAttributeV7 {
	...
	AceEvent eventAnchoredByConstituent(Annotation constit, Document doc,
		...
		if (confidentRoleCount(bestEvent, CONFIDENT_ARG) > 0) {
			...
			if (trainPolModels){
				...
				if (max==0){
					if (polResult[1]>=5)
						bestEvent.polarity="Negative";
					else
						bestEvent.polarity="Positive";
				}
				else
					bestEvent.polarity="Negative";
			...
			if (trainModModels){
				...
				if (max==0){
					if (modResult[1]>=5)
						bestEvent.modality="Other";
					else
						bestEvent.modality="Asserted";
			...
			if (trainGenModels){
				...
				if (max==0){
					if (genResult[1]>=5)
						bestEvent.genericity="Generic";
					else
						bestEvent.genericity="Specific";
			...
			if (trainTenModels){
				...
				if (max==0)
					bestEvent.tense="Future";
				else if (max==1) 
					bestEvent.tense="Past";
				else if (max==2) 
					bestEvent.tense="Present";
				else if (max==3) 
					bestEvent.tense="Unspecified";
	...
	static String logFileName = home+"event_attr1";
	...
	public static void main(String[] args) throws IOException {
		...
		for (int runs = 0; runs < 10; runs++) {
			...
			for (int fold = 0; fold < 10; fold++) {
				...
				ETAttribute et1 = new ETAttribute();
				et1.run();
				...
				ETAttributeV7 et = new ETAttributeV7();
	...
	private static void evaluateEventTagger(ETAttributeV7 et) throws IOException {
