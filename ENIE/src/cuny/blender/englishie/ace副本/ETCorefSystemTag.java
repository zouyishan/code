...
public class ETCorefSystemTag {
	...
	public static void main (String[] args) throws IOException {
		...
		ETCorefSystemTag et = new ETCorefSystemTag();
	...
	private static void evaluateEventTagger (ETCorefSystemTag et)  throws IOException {
