...
public class GenreEventTagger {
	...
	public void tag (String fileList) throws IOException {
		...
		while ((currentDocPath = reader.readLine()) != null) {
		  ...
		  String textFile = ace + (useParser ? "perfect-parses/" : "") + currentDocPath;
			String xmlFile = ace + currentDocPath.replaceFirst(".sgm", ".apf.xml");
			String outputFile = home + "output/event/" + currentDocPath.replaceFirst(".sgm", ".apf");
			// for evaluation --------------
			/*
	...
	static String bcfileList = home + "/bcfilelist";
	static String bnfileList = home + "/bnfilelist";
	static String ctsfileList = home + "/ctsfilelist";
	static String nwfileList = home + "/nwfilelist";
	static String unfileList = home + "/unfilelist";
	static String wlfileList = home + "/wlfilelist";
	
	static String trainfileList1 = home + "trainfilelist1";
	static String trainfileList2 = home + "trainfilelist2";
	static String trainfileList3 = home + "trainfilelist3";
	static String trainfileList4 = home + "trainfilelist4";
	static String trainfileList5 = home + "trainfilelist5";
	static String trainfileList6 = home + "trainfilelist6";
	static String testfileList1 = home + "testfilelist1";
	static String testfileList2 = home + "testfilelist2";
	static String testfileList3 = home + "testfilelist3";
	static String testfileList4 = home + "testfilelist4";
	static String testfileList5 = home + "testfilelist5";
	static String testfileList6 = home + "testfilelist6";
	
	private void splitCorpus() throws IOException{
		ArrayList<String> v1 = new ArrayList<String>();
		BufferedReader reader = new BufferedReader(new FileReader(bcfileList));
		String currentDocPath;
		String[] items;
		while ((currentDocPath = reader.readLine()) != null) {
			items = currentDocPath.split("\\s+");
			v1.add(items[0]+".sgm");
		}
		reader.close();
		
		ArrayList<String> v2 = new ArrayList<String>();
		reader = new BufferedReader(new FileReader(bnfileList));
		while ((currentDocPath = reader.readLine()) != null) {
			items = currentDocPath.split("\\s+");
			v2.add(items[0]+".sgm");
		}
		...
		reader = new BufferedReader(new FileReader(ctsfileList));
		while ((currentDocPath = reader.readLine()) != null) {
			items = currentDocPath.split("\\s+");
			v3.add(items[0]+".sgm");
		}
		...
		reader = new BufferedReader(new FileReader(nwfileList));
		while ((currentDocPath = reader.readLine()) != null) {
			items = currentDocPath.split("\\s+");
			v4.add(items[0]+".sgm");
		}
		...
		reader = new BufferedReader(new FileReader(unfileList));
		while ((currentDocPath = reader.readLine()) != null) {
			items = currentDocPath.split("\\s+");
			v5.add(items[0]+".sgm");
		}
		...
		reader = new BufferedReader(new FileReader(wlfileList));
		while ((currentDocPath = reader.readLine()) != null) {
			items = currentDocPath.split("\\s+");
			v6.add(items[0]+".sgm");
		}
		...
		PrintStream trainWriter1 = new PrintStream (new FileOutputStream (trainfileList1));
		/*PrintStream trainWriter2 = new PrintStream (new FileOutputStream (trainfileList2));
		PrintStream trainWriter3 = new PrintStream (new FileOutputStream (trainfileList3));
		PrintStream trainWriter4 = new PrintStream (new FileOutputStream (trainfileList4));
		PrintStream trainWriter5 = new PrintStream (new FileOutputStream (trainfileList5));
		PrintStream trainWriter6 = new PrintStream (new FileOutputStream (trainfileList6));*/
		
		PrintStream testWriter1 = new PrintStream (new FileOutputStream (testfileList1));
		PrintStream testWriter2 = new PrintStream (new FileOutputStream (testfileList2));
		PrintStream testWriter3 = new PrintStream (new FileOutputStream (testfileList3));
		PrintStream testWriter4 = new PrintStream (new FileOutputStream (testfileList4));
		PrintStream testWriter5 = new PrintStream (new FileOutputStream (testfileList5));
		PrintStream testWriter6 = new PrintStream (new FileOutputStream (testfileList6));
		
		for (int i=0;i<v1.size();i++){
			if (i<v1.size()*0.7)
				trainWriter1.println(v1.get(i));
			else
				testWriter1.println(v1.get(i));
		}
		for (int i=0;i<v2.size();i++){
			if (i<v2.size()*0.7)
				trainWriter1.println(v2.get(i));
			else
				testWriter2.println(v2.get(i));
		}
		for (int i=0;i<v3.size();i++){
			if (i<v3.size()*0.7)
				trainWriter1.println(v3.get(i));
			else
				testWriter3.println(v3.get(i));
		}
		for (int i=0;i<v4.size();i++){
			if (i<v4.size()*0.7)
				trainWriter1.println(v4.get(i));
			else
				testWriter4.println(v4.get(i));
		}
		for (int i=0;i<v5.size();i++){
			if (i<v5.size()*0.7)
				trainWriter1.println(v5.get(i));
			else
				testWriter5.println(v5.get(i));
		}
		for (int i=0;i<v6.size();i++){
			if (i<v6.size()*0.7)
				trainWriter1.println(v6.get(i));
			else
				testWriter6.println(v6.get(i));
		}
		trainWriter1.close();
		/*trainWriter2.close();
		trainWriter3.close();
	...
	public static void main (String[] args) throws IOException {
		...
		FileWriter bw = new FileWriter(home+"en_event_genre_perf1");
		bw.close();
		for (int i=0;i<20;i++){
			GenreEventTagger et = new GenreEventTagger();
			et.splitCorpus();
			if (trainPatterns) {
				if (trainArgModels) {
			...
			if (evaluate) {
				et.anchorMap.clear();
				et.load(eventPatternFile);
				evaluateEventTagger (et,testfileList1);
				EventEval2 ee = new EventEval2();
				ee.evaluate(testfileList1, home+"output/event/");
				bw = new FileWriter(home+"en_event_genre_perf", true);
				bw.write("runs=" + Integer.toString(i) + "\n");
				
				bw.write(df.format(ee.TIP) + "\t" + df.format(ee.TIR) + "\t" + df.format(ee.TIF) + "\t"
						+ df.format(ee.TCP) + "\t" + df.format(ee.TCR) + "\t" +  df.format(ee.TCF)+ "\t"
						+ df.format(ee.AIP)+ "\t" + df.format(ee.AIR) + "\t" +df.format(ee.AIF)  + "\t"
						+ df.format(ee.ACP) + "\t" + df.format(ee.ACR) + "\t" + df.format(ee.ACF) + "\n");
				if (i==0){
					BufferedWriter fw = new BufferedWriter(new OutputStreamWriter(
							new FileOutputStream(home+"bc_error.html"), "UTF-8"));
					fw.write(ee.log.toString());
					fw.close();
				}
				
				evaluateEventTagger (et,testfileList2);
				ee.evaluate(testfileList2, home+"output/event/");
				bw.write(df.format(ee.TIP) + "\t" + df.format(ee.TIR) + "\t" + df.format(ee.TIF) + "\t"
						+ df.format(ee.TCP) + "\t" + df.format(ee.TCR) + "\t" +  df.format(ee.TCF)+ "\t"
						+ df.format(ee.AIP)+ "\t" + df.format(ee.AIR) + "\t" +df.format(ee.AIF)  + "\t"
						+ df.format(ee.ACP) + "\t" + df.format(ee.ACR) + "\t" + df.format(ee.ACF) + "\n");
				if (i==0){
					BufferedWriter fw = new BufferedWriter(new OutputStreamWriter(
							new FileOutputStream(home+"bn_error.html"), "UTF-8"));
					fw.write(ee.log.toString());
					fw.close();
				}
				
				evaluateEventTagger (et,testfileList3);
				ee.evaluate(testfileList3, home+"output/event/");
				bw.write(df.format(ee.TIP) + "\t" + df.format(ee.TIR) + "\t" + df.format(ee.TIF) + "\t"
						+ df.format(ee.TCP) + "\t" + df.format(ee.TCR) + "\t" +  df.format(ee.TCF)+ "\t"
						+ df.format(ee.AIP)+ "\t" + df.format(ee.AIR) + "\t" +df.format(ee.AIF)  + "\t"
						+ df.format(ee.ACP) + "\t" + df.format(ee.ACR) + "\t" + df.format(ee.ACF) + "\n");
				if (i==0){
					BufferedWriter fw = new BufferedWriter(new OutputStreamWriter(
							new FileOutputStream(home+"cts_error.html"), "UTF-8"));
					fw.write(ee.log.toString());
					fw.close();
				}
				
				evaluateEventTagger (et,testfileList4);
				ee.evaluate(testfileList4, home+"output/event/");
				bw.write(df.format(ee.TIP) + "\t" + df.format(ee.TIR) + "\t" + df.format(ee.TIF) + "\t"
						+ df.format(ee.TCP) + "\t" + df.format(ee.TCR) + "\t" +  df.format(ee.TCF)+ "\t"
						+ df.format(ee.AIP)+ "\t" + df.format(ee.AIR) + "\t" +df.format(ee.AIF)  + "\t"
						+ df.format(ee.ACP) + "\t" + df.format(ee.ACR) + "\t" + df.format(ee.ACF) + "\n");
				if (i==0){
					BufferedWriter fw = new BufferedWriter(new OutputStreamWriter(
							new FileOutputStream(home+"nw_error.html"), "UTF-8"));
					fw.write(ee.log.toString());
					fw.close();
				}
				
				evaluateEventTagger (et,testfileList5);
				ee.evaluate(testfileList5, home+"output/event/");
				bw.write(df.format(ee.TIP) + "\t" + df.format(ee.TIR) + "\t" + df.format(ee.TIF) + "\t"
						+ df.format(ee.TCP) + "\t" + df.format(ee.TCR) + "\t" +  df.format(ee.TCF)+ "\t"
						+ df.format(ee.AIP)+ "\t" + df.format(ee.AIR) + "\t" +df.format(ee.AIF)  + "\t"
						+ df.format(ee.ACP) + "\t" + df.format(ee.ACR) + "\t" + df.format(ee.ACF) + "\n");
				if (i==0){
					BufferedWriter fw = new BufferedWriter(new OutputStreamWriter(
							new FileOutputStream(home+"un_error.html"), "UTF-8"));
					fw.write(ee.log.toString());
					fw.close();
				}
				
				evaluateEventTagger (et,testfileList6);
				ee.evaluate(testfileList6, home+"output/event/");
				bw.write(df.format(ee.TIP) + "\t" + df.format(ee.TIR) + "\t" + df.format(ee.TIF) + "\t"
						+ df.format(ee.TCP) + "\t" + df.format(ee.TCR) + "\t" +  df.format(ee.TCF)+ "\t"
						+ df.format(ee.AIP)+ "\t" + df.format(ee.AIR) + "\t" +df.format(ee.AIF)  + "\t"
						+ df.format(ee.ACP) + "\t" + df.format(ee.ACR) + "\t" + df.format(ee.ACF) + "\n");
				if (i==0){
					BufferedWriter fw = new BufferedWriter(new OutputStreamWriter(
							new FileOutputStream(home+"wl_error.html"), "UTF-8"));
					fw.write(ee.log.toString());
					fw.close();
				}
				bw.close();
				
				/*bw = new FileWriter(home+"en_event_genre_log");
				bw.flush();
	...
	private static void trainCorefModel (GenreEventTagger et) throws IOException {
		argModel = loadClassifierModel(argModelHalfFileName);
		roleModel = loadClassifierModel(roleModelHalfFileName);
	...
	private static void evaluateEventTagger (GenreEventTagger et, String fileListTest)  throws IOException {
