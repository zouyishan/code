...
public class ETCTV1 {
	...
	private static void trainCorefModel(ETCTV1 et) throws IOException {
		argModel = loadClassifierModel(argModelHalfFileName);
		roleModel = loadClassifierModel(roleModelHalfFileName);
	...
	private static void evaluateEventTagger(ETCTV1 et) throws IOException {
