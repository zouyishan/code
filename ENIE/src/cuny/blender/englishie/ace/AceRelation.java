...
public class AceRelation {
	...
	public void write (BufferedWriter w) throws IOException {
		w.append   ("  <relation ID=\"" + id + "\" TYPE=\"" + type + "\"");
		if (subtype != null && !subtype.equals(""))
		  w.append (" SUBTYPE=\"" + subtype + "\"");
		if (!AceDocument.ace2004)
			w.append (" CLASS=\"" + relClass + "\"");
		w.append (">");
		if (AceDocument.ace2005) {
			w.append ("    <relation_argument REFID=\"" + arg1.id + "\" ROLE=\"Arg-1\" />\n");
			w.append ("    <relation_argument REFID=\"" + arg2.id + "\" ROLE=\"Arg-2\" />\n");
		} else {
			w.append ("    <rel_entity_arg ENTITYID=\"" + arg1.id + "\" ARGNUM=\"1\" />\n");
			w.append ("    <rel_entity_arg ENTITYID=\"" + arg2.id + "\" ARGNUM=\"2\" />\n");
		}
		if (!AceDocument.ace2004) w.append ("    <relation_mentions>\n");
