...
public class ETST {
	...
	static final String home = "/home/zheng/Application/EngET/st/";
	...
	private static void trainCorefModel(ETST et) throws IOException {
		argModel = loadClassifierModel(argModelHalfFileName);
		roleModel = loadClassifierModel(roleModelHalfFileName);
	...
	private static void evaluateEventTagger(ETST et) throws IOException {
