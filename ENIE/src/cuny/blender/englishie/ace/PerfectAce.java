...
import cuny.blender.englishie.nlp.pat.NewAnnotationAction;
import cuny.blender.englishie.nlp.pat.Pat;
import cuny.blender.englishie.nlp.refres.*;
...
public class PerfectAce extends Resolve {
	...
	public static boolean validMention (Document doc, Annotation head, String cat) {
		...
		if (cat == "title") {
			Annotation[] tokens = cuny.blender.englishie.nlp.lex.Tokenizer.gatherTokens(doc, head.span());
