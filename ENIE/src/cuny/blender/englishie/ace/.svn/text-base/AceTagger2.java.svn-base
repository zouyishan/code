...
public class AceTagger2 {
	...
	public static void main (String[] args) throws IOException {
		...
		while ((currentDocPath = reader.readLine()) != null) {
			...
			tagFile2(home+docPathMap.get(currentDocPath),currentDocPath);
		}
	...
	public static void init2 () throws IOException {
		...
		relationTagger = new RelationTagger();
		
		//tagger.trainRelationModel();
		relationTagger.loadModels();
	...
	public static void tagFile (String currentDocPath,String currentDocPathBase) throws IOException{
		System.out.println ("\nTagging document "  + ": " + currentDocPathBase);
