...
public class ETCorefBestPar {
	...
	public static void main (String[] args) throws IOException {
		...
		for (int runs = 0; runs < 1; runs++) {
			...
			for (int fold = 0; fold < 1; fold++) {
				...
				ETCorefBestPar et = new ETCorefBestPar();
	...
	private static void evaluateEventTagger (ETCorefBestPar et)  throws IOException {
