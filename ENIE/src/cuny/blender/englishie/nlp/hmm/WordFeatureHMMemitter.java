...
package cuny.blender.englishie.nlp.hmm;
...
public class WordFeatureHMMemitter extends HMMemitter {
	...
	public void trainOnInstances (String token, String priorToken, int n) {
		count += n;
		if (cuny.blender.englishie.ace.Ace.monocase && (stateName.startsWith("b-") || stateName.startsWith("m-") ||
	...
	public double getProbability (String token, String priorToken, FeatureSet fs) {
		...
		if (forcedCap || cuny.blender.englishie.ace.Ace.monocase) {		// << added Oct. 2
		...
		if (tprob != null)
			...
			if ((forcedCap && tokenForm == "initCap") || cuny.blender.englishie.ace.Ace.monocase)
				tokenForm = "forcedCap";
