...
class NameCoref {
	...
	public static void main (String[] args) throws IOException {
		...
		cuny.blender.englishie.ace.EDTtype.readTypeDict(dictFile);
		cuny.blender.englishie.ace.Ace.gazetteer = new Gazetteer();
		cuny.blender.englishie.ace.Ace.gazetteer.load(ACEdir + "loc.dict");
		// turn off traces
		Pat.trace = false;
		Resolve.trace = false;
	...
	private static void processCollection (String testCollection, String keyCollection)
		...
		// open test document
			...
			System.out.println ("Processing document " + docCount + " " +
			                    testDoc.fileName());
			cuny.blender.englishie.ace.Ace.monocase = cuny.blender.englishie.ace.Ace.allLowerCase(testDoc);
