...
import cuny.blender.englishie.nlp.hmm.Retagger;
   ...
   */
	...
	private static void parseCollection(String inputDir, String outputDir, String fileList)
		...
		for (int docCount = 0; docCount < col.size(); docCount++) {
			...
			cuny.blender.englishie.nlp.hmm.BigramHMMemitter.useBigrams = cuny.blender.englishie.ace.Ace.monocase;
			cuny.blender.englishie.nlp.hmm.HMMstate.otherPreference = cuny.blender.englishie.ace.Ace.monocase ? 1.0 : 0.0;
