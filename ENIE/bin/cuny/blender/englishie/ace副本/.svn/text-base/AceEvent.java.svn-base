...
public class AceEvent {
   ...
   */
	...
	public void write (BufferedWriter w) throws IOException {
		w.append   ("  <event ID=\"" + id + "\" TYPE=\"" + type + "\"");
		if (subtype != null && !subtype.equals(""))
		  w.append (" SUBTYPE=\"" + subtype + "\"");
		w.append (" MODALITY=\"" + modality + "\"");
		w.append (" POLARITY=\"" + polarity + "\"");
		w.append (" GENERICITY=\"" + genericity + "\"");
		w.append (" TENSE=\"" + tense + "\"");
		w.append (" MODPROB=\"" + modProb + "\"");
		w.append (" POLPROB=\"" + polProb + "\"");
		w.append (" GENPROB=\"" + genProb + "\"");
		w.append (" TENPROB=\"" + tenProb + "\"");
		w.append (">\n");
