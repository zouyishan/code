...
public class AceTest {
	...
	//    "C:/Users/blender/Workspace/GALE/workspace/ENEventTagger/";
	//static final String ace =
	//    "C:/Users/blender/Workspace/GALE/workspace/ENEventTagger/ACE05/";
	//static final String home = "/home/zheng/Application/SRL/";
	static final String home = "C:/Users/blender/workspace/blender/corpus/ASR/";
	static final String ace = "/home/zheng/Application/SRL/ACE05/";
	...
	public static void main (String[] args) throws IOException {
		...
		/*String propertyFile = home + "props/MEace09.properties";//args[0];
		String fileList = ace+ "SRL/srlfilelist";//args[1];
		docDir = ace+"SRL/output/";//args[2];
		outputDir = ace+"SRL/tagged/";//args[3];
		parseDir = null;
		...
		String propertyFile = home + "../../props/MEace06.properties";//args[0];
		String fileList = home+ "filelist";//args[1];
		docDir = home+"asr.txt/";//args[2];
		outputDir = home+"output/";//args[3];
		parseDir = null;
	...
	static void processFile (String currentDocPath) throws IOException{
