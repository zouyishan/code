...
public class ETAttributeV2 {
	...
	public static void main(String[] args) throws IOException {
		...
		//	Collections.shuffle(v);
			...
			//	splitCorpus(fold,v);
				ETAttributeV2 et = new ETAttributeV2();
	...
	private static void evaluateEventTagger(ETAttributeV2 et) throws IOException {
