...
public class AceTagger {
	...
	// relational model
	public static RelationTagger6 eve = null;
	public static RelationPatternSet eve1 = null;
	static ETGraphCorefSystem eventTagger = null;

	static RelationTagger relationTagger = null;
	...
	public static void main (String[] args) throws IOException {
		// get arguments
		dataHome = args[0];
		//dataHome="C:/Users/blender/EnglishIE/ENIE/";
		init();
		home = args[1];
		//home = "C:/Users/blender/Project/GALE/software/Corpus/KBP/2010Data/TAC_2010_KBP_Source_Data/";
		//String home = "C:/Users/blender/Project/GALE/software/Corpus/KBP/2010Data/TAC_2010_KBP_Source_Data/";
		//String fileList = "C:/Users/blender/TAC/KBP/output/docidlist2";
		String fileList = args[2];
		dtdFile = home + "apf.v5.1.1.dtd";
		String dataMapFile = home + "docs/kbp_2010_docid_to_file_mapping.tab";
		BufferedReader reader = new BufferedReader (new FileReader(fileList));
		String currentDocPath;
		//System.out.println(dataMapFile);
		
		loadSrcPathData(dataMapFile);
		
		int n=0;
		while ((currentDocPath = reader.readLine()) != null) {
			n++;
			System.out.println("Processing "+n+":"+currentDocPath);
			tagFile1(home+docPathMap.get(currentDocPath),currentDocPath);
		}
		//tagFile("C:/Users/blender/workspace5/TAC/corpus/TAC_2009_KBP_Evaluation_Source_Data/data/nw/afp_eng/20070311/AFP_ENG_20070311.0055.LDC2009T13.sgm","AFP_ENG_20070311.0055.LDC2009T13");
	}
	...
	public static void init () throws IOException {
		...
		String propertyFile =  dataHome+"props/MEace06.properties";
		...
		if (relationPatternFileName != null) {
			eve1 = new RelationPatternSet();
			eve1.load(relationPatternFileName, 0);
		} else {
	...
	public static void init2 () throws IOException {
		// get arguments
		String home = "C:/Users/blender/workspace/blender/";
		String propertyFile = home + "props/MEace06.properties";
		...
		// load relational model
		String relationModelsDir = JetTest.getConfigFile("Ace.RelationModels.directory");
		if (relationModelsDir != null) {
			eve = new RelationTagger6();
			eve.loadModels();
		} else {
			System.out.println ("Ace:  no relation pattern file name specified in config file");
			System.out.println ("      Will not tag relations.");
	...
	public static void tagFile (ExternalDocument txtdoc, String currentDocPath,String currentDocPathBase) throws IOException{
		String currentDocFileName = currentDocPathBase+".sgm";
		doc = txtdoc;
		...
		String tagDir = currentDocPath.replace("/data/", "/tagged1/");
		int pos = tagDir.lastIndexOf('/');
		tagDir = tagDir.substring(0,pos+1);
		File tagFileDir = new File(tagDir);
		...
		String apfFileName = tagDir + currentDocPathBase + suffix;
		...
		if (eve != null)
			...
			eve.Tag(doc, aceDoc,currentDocPathBase);
		int choice = 1;
		// build events
		if (eventTagger != null){
	...
	public static void tagFile1 (String currentDocPath,String currentDocPathBase) throws IOException{
		String currentDocFileName = currentDocPathBase+".sgm";
		
		String tagDir = currentDocPath.replace("/data/", "/tagged/");
		int pos = tagDir.lastIndexOf('/');
		tagDir = tagDir.substring(0,pos+1);
		File tagFileDir = new File(tagDir);
	...
	public static void tagFile2 (String currentDocPath,String currentDocPathBase) throws IOException{
		String currentDocFileName = currentDocPathBase+".sgm";
		doc = new ExternalDocument("sgml",  currentDocPath);
		...
		/*if (relationTagger != null)
			relationTagger.Tag(doc, aceDoc,docId+".sgm");*/
		if (eve != null)
			eve.Tag(doc, aceDoc,currentDocPathBase);
		int choice = 1;
		// build events
	...
	static void processFile (String currentDocPath,String currentDocPathBase) throws IOException{
		...
		String tagDir = outputDir+currentDocPath.replace("data", "tagged");
		int pos = tagDir.lastIndexOf('/');
		tagDir = tagDir.substring(0,pos+1);
		File tagFileDir = new File(tagDir);
		if (!tagFileDir.exists())
